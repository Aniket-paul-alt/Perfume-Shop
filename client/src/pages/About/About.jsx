        ...
        <>
            ...
            <Container className="about-container my-5">
                <Row className="justify-content-center">
                    <Col md={8}> {/* Adjust column width for better centering */}
                        <h1 className="text-center mb-4 title">About Us</h1>
                        <p className="text-center paragraph">
                            Welcome to AromaLuxe, a Premium Perfume Shop, your number one source for all things fragrance.
                        ...
                        <p className="text-center paragraph">
                            Sincerely,<br />
                            <span className="team">AromaLuxe</span>
                        </p>
                    </Col>
                </Row>
            </Container>
